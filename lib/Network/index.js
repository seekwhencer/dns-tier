...
export default class Network extends Module {
    ...
    /**
     * create a interfaces configuration
    ...
    /**
     *
     * @param bin           with absolute path to the executable
     * @param params        Array with command line parameters, every field equals a
     * @returns {Promise<any>}
     */
    command(bin, params) {
        return new Promise((resolve, reject) => {
     ...
     * @returns {Promise<any>}
     */
    restartService = () => this.command('/usr/sbin/service', ['networking', 'restart']);
